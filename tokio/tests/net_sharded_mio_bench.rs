//! TCP echo throughput benchmark for the per-worker sharded-mio reactor.
//!
//! The same binary is compiled twice — once with `io-sharded-mio` enabled,
...
//!     --features 'rt,rt-multi-thread,net,io-sharded-mio,time,io-util' \
